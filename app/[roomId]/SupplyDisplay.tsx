// --- FILE: app/[roomId]/SupplyDisplay.tsx (拡張順ソート追加版) ---
'use client';
...
export default function SupplyDisplay({ initialCards }: { initialCards: CardType[] }) {
  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-900 min-h-screen">
      ...
      <div className={`fixed inset-y-0 left-0 z-40 w-4/5 bg-gray-50 dark:bg-gray-800 transform transition-transform duration-300 ease-in-out shadow-2xl ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}><Sidebar allCards={allCards} allExpansions={allExpansions} selectedExpansions={selectedExpansions} onExpansionChange={handleExpansionChange} /></div>
