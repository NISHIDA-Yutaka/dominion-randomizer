// --- FILE: app/[roomId]/SupplyDisplay.tsx (デバッグ強化版) ---
'use client';
  ...
  const handleRerollSelected = async () => {
    ...
    try {
      ...
      if (updateError) {
        ...
        console.error("Supabase update error (reroll):", updateError);
        throw new Error(updateError.message);
      }
